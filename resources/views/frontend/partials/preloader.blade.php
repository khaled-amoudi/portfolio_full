    ...
    <div class="preloader">
        <div class="preloader-inner">
            <div class="logo-html">
                ...
                <span class="block-9 preloader-text fw-bolder text-gradient-main">NEVER GOES OFF</span>
            </div>
        </div>
        <div class="loaderio">
        ...
        <style type="text/css">
            ...
            .ldio-yzaezf3dcmj>div:nth-child(1) div:nth-child(1) {
                animation-delay: -0.67s
            }

            .ldio-yzaezf3dcmj>div:nth-child(1) div:nth-child(2) {
                animation-delay: -0.33s
            }

            .ldio-yzaezf3dcmj>div:nth-child(1) div:nth-child(3) {
                animation-delay: 0s
            }
