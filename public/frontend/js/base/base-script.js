...
///////////////////////////////////////////////////////////////////
ScrollReveal().reveal(
    ".skills .card, .teachers-section .card, .social-section .reveal"
);
///////////////////////////////////////////////////////////////////
...
$(document).ready(function () {
    ...
    ///////////////////////////////////////////////////////////
    // Animation Elements like WOWjs {Start} ##################
    $(document).ready(function () {
        setTimeout(() => {
            $("._cstm_wow_fadeInLeft").addClass("_cstm_wow_fadeInLeft_animate");
            $("._cstm_wow_fadeInRight").addClass(
                "_cstm_wow_fadeInRight_animate"
            );
    ...
    $(
        ".routeAboutPage, .routePortfolioPage, .routeContactPage, .routeHomePage"
    ).on("click", function () {
        if ($(this).hasClass("routeAboutPage")) {
            ...
            openContactPage();
        } else if ($(this).hasClass("routeHomePage")) {
            openHomePage();
        }
    });
    ...
    function openHomePage() {
        ...
        side_bar_status("hide");
        $("body").children().not(".cursor, .side_bar, .preloader").fadeOut(600);
        $(".main-body").delay(300).fadeIn(600);
        $(window).scrollTop(0);
    ...
    function enableSection(section_id) {
        side_bar_status("show");
        $("body").children().not(".cursor, .side_bar, .preloader").fadeOut(600);
        $(section_id).delay(300).fadeIn(600);
        $(window).scrollTop(0);
    }
    ...
    /////////////////////////////////////////////////////////////////////////
    function side_bar_status(status) {
        if (status == "show") {
            $(".side_bar").css({ left: "1rem", transitionDuration: ".4s" });
        } else if (status == "hide") {
            $(".side_bar").css({ left: "-70px", transitionDuration: ".4s" });
        }
    }
