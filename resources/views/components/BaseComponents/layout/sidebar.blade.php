        <aside class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="{{ asset('admin/assets/images/main-logo.svg') }}"
                        style="width: 30px; filter: unset !important;" class="" alt="logo icon">
                </div>
                <div>
                    <h4 class="logo-text fw-bolder">5VLD</h4>
                </div>
