<div class="side_bar_mobile d-block d-md-none overflow-hidden shadow-lg py-3 mb-0 mx-0">
    <div class="d-flex w-100">
        <div class="side_bar_mobile_nav text-white fs-8px fw-light letter-spacing-1px d-flex flex-wrap justify-content-evenly text-center w-100 h-100">
            <div class="nav-home">
                <a class="routeHomePage cursor-pointer text-white text-decoration-none">
                    <div class="side_bar_nav_icon active">
            ...
            <div class="routeContactPage nav-contact mt-auto cursor-pointer">
                <div class="side_bar_nav_icon">
